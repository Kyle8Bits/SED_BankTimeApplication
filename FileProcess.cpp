...
bool FileProcess::saveToFile(std::vector<Member*> member_list){
...
Status FileProcess::statusEnum(string status){
    if (status == "OFFLINE"){
...
std::vector<Member*> FileProcess::loadData(std::vector<Member*>& member_list){//Pass the member_list by reference
    std::fstream my_file;
...
std::vector<string> FileProcess::readSkillSupporter(string id_skill){
    std::vector<string> skill_list;
    std::fstream my_file;
...
std::vector<string> FileProcess::readBlockList(string id){
    std::vector<string> block_list;
    std::fstream my_file;
...
std::vector<std::pair<std::string, std::vector<std::pair<Time, Time>>>> FileProcess::readWorkDay(const std::string& id_time) {
...
bool FileProcess::saveBookingFile(std::vector<BookingSupporter*>& booking_list){
    std::fstream my_file;
...
std::vector<BookingSupporter*> FileProcess::loadBookingFile(std::vector<BookingSupporter*>& booking_list){
    std::fstream my_file;
